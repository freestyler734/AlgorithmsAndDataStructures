...
public class BinarySearchTree<K extends Comparable<K>, V> {
    ...
    public void visualizeTree(){
        ...
        for (int i = 0; i < heapStructure.length; i++) {
            ...
            System.out.printf(" %s ", heapStructure[i] == null ? "  " : heapStructure[i]);
     ...
     * @param leftChild
     */
    protected void setLeftRelation(Node parent, Node leftChild) {
     ...
     * @param rightChild
     */
    protected void setRightRelation(Node parent, Node rightChild) {
     ...
     * @param leftChild
     */
    protected void deleteLeftReleation(Node parent, Node leftChild) {
     ...
     * @param rightChild
     */
    protected void deleteRightReleation(Node parent, Node rightChild) {
